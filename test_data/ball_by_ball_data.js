...
export async function createBallByBallData() {
  ...
  const allInnings = [
    { matchId: matchStartId + 0, team_id: teamsId[0].team1_id, inning: match1Innings1 },
    { matchId: matchStartId + 0, team_id: teamsId[0].team2_id, inning: match1Innings2 },
    { matchId: matchStartId + 1, team_id: teamsId[1].team1_id, inning: match2Innings1 },
    { matchId: matchStartId + 1, team_id: teamsId[1].team2_id, inning: match2Innings2 },
    { matchId: matchStartId + 2, team_id: teamsId[2].team1_id, inning: match3Innings1 },
    { matchId: matchStartId + 2, team_id: teamsId[2].team2_id, inning: match3Innings2 },
    { matchId: matchStartId + 3, team_id: teamsId[3].team1_id, inning: match4Innings1 },
    { matchId: matchStartId + 3, team_id: teamsId[3].team2_id, inning: match4Innings2 },
    { matchId: matchStartId + 4, team_id: teamsId[4].team1_id, inning: match5Innings1 },
    { matchId: matchStartId + 4, team_id: teamsId[4].team2_id, inning: match5Innings2 },
  ]
